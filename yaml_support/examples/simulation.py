...
from yaml_support.ws.parser_node import (
    WSSenderNode,
    WSSenderConfig,
)

from yaml_support.util.helper_functions import get_caller_info
...
class Demo(lg.Graph):
    ...
    def setup(self) -> None:
        ...
        self.WS_SENDER.configure(
            WSSenderConfig(path=get_caller_info())
        )
    ...
    def process_modules(self) -> Tuple[lg.Module, ...]:
        return (self.SIMULATIONGENERATOR, self.PLOT, self.WS_SENDER)
